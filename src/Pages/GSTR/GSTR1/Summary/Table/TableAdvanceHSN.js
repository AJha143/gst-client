...
const rows = [
  createData("HSN Sections", 305, 3.7, 67, 4.3),
  createData("HSN Sections", 452, 25.0, 51, 4.9),
  createData("HSN Sections", 262, 16.0, 24, 6.0),
];
...
export default function TableAdvanceHSN() {
