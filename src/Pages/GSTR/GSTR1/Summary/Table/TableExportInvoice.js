...
const rows = [
  createData("Export Invoices", 305, 3.7, 67, 4.3),
  createData("Export Invoices", 452, 25.0, 51, 4.9),
  createData("Export Invoices", 262, 16.0, 24, 6.0),
];
...
const headCells = [
  ...
  },
  {
    ...
    label: "Total Rec. Count",
  },
  {
    id: "fat",
    numeric: true,
    disablePadding: false,
    label: "Total Rec. Value",
  },

  {
    ...
    numeric: true,
    disablePadding: false,
    label: "Tot. Taxable Value",
  },
];

export default function TableExportInvoice() {
